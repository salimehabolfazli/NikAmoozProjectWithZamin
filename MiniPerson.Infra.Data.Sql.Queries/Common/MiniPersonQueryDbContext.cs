...
{
    public partial class MiniPersonQueryDbContext : BaseQueryDbContext
    {
        public MiniPersonQueryDbContext(DbContextOptions<MiniPersonQueryDbContext> options) : base(options)
        {
        }
